...
!function(d) {
    ...
    d(document).on("ready", function() {
        var e, a, s, t, i, l, o, n;
        c(),
        d("*[data-pattern-overlay-darkness-opacity]").each(function() {
        ...
        d("#full-container").fitVids(),
        d(".video-background").each(function() {
            d(this).YTPlayer({
                mute: !1,
                autoPlay: !0,
                opacity: 1,
        ...
        t = d(".banner-parallax"),
        i = t.children("img:first-child").attr("src"),
        t.prepend("<div class='bg-element'></div>"),
        t.find("> .bg-element").css("background-image", "url('" + i + "')").attr("data-stellar-background-ratio", .2),
        d(".parallax-section").each(function() {
            var e = d(this)
        ...
        l.on("resized.owl.carousel", function(e) {
            var a = e.item.index
              , s = d(".slider-boxes-features-1 > .owl-carousel .owl-item");
            r.hasClass("device-lg") || r.hasClass("device-md") ? (s.removeClass("highlighted"),
            s.eq(a + 1).addClass("highlighted")) : (r.hasClass("device-sm") || r.hasClass("device-xs") || r.hasClass("device-xxs")) && (s.removeClass("highlighted"),
            s.eq(a).addClass("highlighted"))
        }),
        ...
        n.on("resized.owl.carousel", function(e) {
            var a = e.item.index
              , s = d(".slider-boxes-features-3 > .owl-carousel .owl-item");
            r.hasClass("device-lg") || r.hasClass("device-md") ? (s.removeClass("highlighted"),
            s.eq(a).addClass("highlighted")) : (r.hasClass("device-sm") || r.hasClass("device-xs") || r.hasClass("device-xxs")) && (s.removeClass("highlighted"),
            s.eq(a).addClass("highlighted"))
        }),
        ...
        d(".counter-stats").each(function() {
            ...
            e.html(s + "<div class='main'>" + a + "</span>"),
        ...
        function() {
            ...
            var e = m.data("success-msg")
              , l = e || "Thank You We will contact you via email ";
              
            d("#form-cta-subscribe-2").on("submit", function(e) {
                if (e.preventDefault(), s = d("#cs2Name").val(),
                t = d("#cs2Email").val(),
                i = d("#cs2PhoneNum").val()) {
                    var a = '<i class="cs-success-icon fas fa-check"></i>' + l;
                    p(!1, a),
                    v()
                }
                var s, t, i
    ...
    d(window).on("load", function() {
        ...
        function() {
                setTimeout(function() {
                    ...
                    d(".ss-icon").toggleClass("rotating")
                }, 2e3),
                d(".demos-preview li a").each(function() {
                    var a = d(this);
                    a.hover(function() {
                        var e = a.find("img").attr("src");
                        d(".dp-img").attr("src", e).toggleClass("appeared")
                    })
                }),
                d(".ss-icon").on("click", function(e) {
                    e.preventDefault(),
                    d(this).toggleClass("rotating")
                }),
                d(".switch-button").each(function() {
                    d(this).on("click", function() {
                        d(this).toggleClass("active"),
                        d(this).next().toggleClass("active"),
                        d(this).prev().toggleClass("active")
                    }),
                    d(this).prev("span").on("click", function() {
                        d(this).addClass("active"),
                        d(this).nextAll().removeClass("active")
                    }),
                    d(this).next("span").on("click", function() {
                        d(this).addClass("active"),
                        d(this).prev(".switch-button").addClass("active").prevAll("span:first-child").removeClass("active")
                    })
                }),

                d(".page-width-option .switch-button").each(function() {
                    d("body").hasClass("boxed") && (d(this).addClass("active"),
                    d(this).prev("span").removeClass("active"),
                    d(this).next("span").addClass("active"),
                    d(".list-patterns").removeClass("hidden")),
                    d(this).on("click", function() {
                        d("body").toggleClass("boxed"),
                        d("body").hasClass("boxed") && d("body").is("[class*='bg-pattern-']")
                    }),
                    d(this).prev("span").on("click", function() {
                        d("body").removeClass("boxed")
                    }),
                    d(this).next("span").on("click", function() {
                        d("body").addClass("boxed")
                    })
                });
    ...
    function h() {
        d(".fullscreen, #home-header, #home-banner").css("height", d(window).height()),
        d("#banner.fullscreen").css("height", d(window).height())
    }
    d(".banner-parallax").each(function() {
        var e = d(this).data("banner-height")
          , a = d(this).find(".row > [class*='col-']");
        d(this).css("min-height", e),
        d(a).css("min-height", e)
    });
    ...
    function s() {
        ...
        d("#scroll-progress .scroll-progress").width(a + "%"),
        d(".scroll-percent").text(a.toFixed(0) + "%")
    }
    u = "rtl" == e,
    d(".scroll-to").on("click", function(e) {
        e.preventDefault();
    ...
    function v() {
        m.css("opacity", 0),
        m.slideDown(300).animate({
            opacity: 1
        }, 300),
        d(".cs-notifications-content").removeClass("sent")
    }
    function p(e, a) {
        var s;
        s = "shake animated",
        m.delay(300).addClass(s).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
